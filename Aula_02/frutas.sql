...
SELECT max(preco) as menor_preco FROM tb_produtos;

-- traz todos menos sacola, porque não tem categoria associada
SELECT * FROM tb_produtos INNER JOIN tb_categorias
ON tb_produtos.categoria_id = tb_categorias.id;

-- produtos sem categoria + left
